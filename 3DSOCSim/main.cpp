...
#include "../src/physics/solveSBMProcessor3D.h"
#include "../src/physics/solveSBMProcessor3D.hh"
#include "../src/physics/dataWrapper3D.h"
...
int main(int argc, char *argv[]) {
	...
	// Cahn-Hillard step
	compute_SBM_CH_step<T>(blocksForSim, dmn, param);
