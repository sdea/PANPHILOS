...
#include "../src/physics/solveSBMProcessorContactAngle2D.h"
#include "../src/physics/solveSBMProcessorContactAngle2D.hh"
#include "../src/physics/dataWrapperContactAngle2D.h"
...
int main(int argc, char *argv[]) {
	...
	// Cahn-Hillard step
	compute_SBM_CH_step_contact_angle_2D<T>(blocksForSim, dmn, param);
