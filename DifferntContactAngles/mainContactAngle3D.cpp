...
// Data processors
#include "../src/io/InputOutputContactAngle.h"
#include "../src/physics/ApplyNoFlux3DFunctional.h"
#include "../src/physics/ApplyNoFlux3DFunctional.hh"
#include "../src/physics/solveSBMProcessorContactAngle3D.h"
#include "../src/physics/solveSBMProcessorContactAngle3D.hh"
#include "../src/physics/dataWrapperContactAngle3D.h"
...
int main(int argc, char *argv[]) {
    ...
    blocksForSim.push_back(&CosTheta);
	...
	// Cahn-Hillard step
	compute_SBM_CH_step_contact_angle<T>(blocksForSim, dmn, param);
